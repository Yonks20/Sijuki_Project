  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <form action="connect-kategorisatuan.php" method="post">

<div class="row mb-3">
<label for="nama" class="col-sm-2 col-form-label nama" name="nama">Kategori Satuan</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="kategori_satuan" id="kategori_satuan">
</div>
</div>
