  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <form action="connect-tipetarget.php" method="post">

<div class="row mb-3">
<label for="nama" class="col-sm-2 col-form-label nama" name="nama">Tipe Target</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="tipe_target" id="tipe_target">
</div>
</div>
